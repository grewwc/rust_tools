...
const FEISHU_SCOPE: &str = "sheets:spreadsheet:write_only sheets:spreadsheet:create docs:document:export docx:document:readonly wiki:node:read wiki:node:retrieve sheets:spreadsheet:read offline_access contact:user.employee_id:readonly im:message:send_as_bot drive:drive.metadata:readonly docs:document.media:download base:app:create base:app:read base:app:update base:field:create base:field:delete base:field:update base:record:create base:record:delete base:record:update base:table:create base:table:delete base:table:update base:view:read base:view:write_only drive:file:download drive:file:upload docs:document.media:upload docx:document:create docx:document:write_only contact:contact.base:readonly board:whiteboard:node:read docs:document.comment:read base:table:read base:record:retrieve base:field:read im:chat:read im:chat.members:read docs:document.comment:update docs:document.comment:create task:task:read calendar:calendar.event:read calendar:calendar:read contact:user.base:readonly base:app:copy search:docs:read";
